...
function showAnswerVoteChange(assetDoc) {
    ...
    var answer_id = assetDoc.answer;
    var currentQuestionUpvotes = $('.answer.'+ answer_id +' .question_total').data('upvotes');
    var currentQuestionDownvotes = $('.answer.'+ answer_id +' .question_total').data('downvotes');

    if (assetDoc.vote_type_prev) {
        if (assetDoc._deleted) {
            if (assetDoc.vote_type == 'upvote') currentQuestionUpvotes--;
            if (assetDoc.vote_type == 'downvote') currentQuestionDownvotes--;
        } else {
            if (assetDoc.vote_type_prev == 'upvote' && assetDoc.vote_type == 'downvote') {
                currentQuestionUpvotes--;
                currentQuestionDownvotes++
            }
            if (assetDoc.vote_type_prev == 'downvote' && assetDoc.vote_type == 'upvote'){
                currentQuestionUpvotes++;
                currentQuestionDownvotes--;
            }
        }
